/*  Chris de Leon
    ...
    // Intitial request to load images
...
/* possible code for astronaut information get
 var launchGet = document.getElementById('launchGet');

    launchGet.addEventListener('click', function () { // function to 
        httpRequest.send();
    })
*/